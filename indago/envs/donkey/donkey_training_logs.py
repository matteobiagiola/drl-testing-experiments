...
class DonkeyTrainingLogs(TrainingLogs):
    def __init__(
        ...
        # self.ctes = ctes
        # episode length
        self.regression_value = None if fitness_values is None else min(fitness_values)
